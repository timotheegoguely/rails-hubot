...
user1 = User.create!(email: "john@doe.com", password:"123456", first_name:"John", last_name:"Doe", phone_number:"+33 6 28 48 39 11", gender:"male", description:"Nullam id dolor id nibh ultricies vehicula ut id elit.", birth_date: DateTime.new(1990,1,1), owner: true)
user2 = User.create!(email: "bill@gmail.com", password:"123456", first_name:"Bill", last_name:"Jack", phone_number:"+33 6 84 37 94 29", gender:"male", description:"Praesent commodo cursus magna, vel scelerisque nisl consectetur et.", birth_date: DateTime.new(1980,1,1), owner: true)
user3 = User.create!(email: "tom@yahoo.com", password:"123456", first_name:"Tom", last_name:"Sayer", phone_number:"+33 6 00 74 82 16", gender:"male", description:"Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.", birth_date: DateTime.new(1982,1,1), owner: true)
user4 = User.create!(email: "mathew@gmail.com", password:"123456", first_name:"Mathew", last_name:"Barney", phone_number:"+33 6 39 28 44 17", gender:"male", description:"Morbi leo risus, porta ac consectetur ac, vestibulum at eros.", birth_date: DateTime.new(1983,1,1), owner: true)
user5 = User.create!(email: "tim@gmail.com", password:"123456", first_name:"Tim", last_name:"Barks", phone_number:"+33 6 93 47 28 11", gender:"male", description:"Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum.", birth_date: DateTime.new(1981,1,1), owner: true)
user6 = User.create!(email: "thomas@yahoo.com", password:"123456", first_name:"Thomas", last_name:"Richards", phone_number:"+33 6 09 89 38 24", gender:"male", description:"Curabitur blandit tempus porttitor.", birth_date: DateTime.new(1991,1,1), owner: true)
user7 = User.create!(email: "eva@gmail.com", password:"123456", first_name:"Eva", last_name:"Joly", phone_number:"+33 6 37 48 28 94", gender:"female", description:"Praesent commodo cursus magna, vel scelerisque nisl consectetur et.", birth_date: DateTime.new(1985,1,1), owner: true)
